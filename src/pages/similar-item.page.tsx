    ...
    <>
      ...
      <div className="w-full px-8 py-6">
        ...
        {Domains.filter((item) => item.id === id).map((item) => (
          <div key={item.id}>
            {item.similar
              .filter((similarItem) => similarItem.id === similarId)
              .map((item) => (
                <div key={`similar_${item.id}`}>
                  <div className="flex flex-col gap-3">
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      {/* <Button
                        onClick={() =>
                          openDialog("generateSimilar", { id: item.id })
                        }
                        size={"lg"}
                        variant={"outline"}
                        className="cursor-pointer bg-white rounded-lg h-12 border text-gray-700 text-[16px] leading-6 font-semibold border-gray-300 py-3 px-5 shadow-[0px 1px 2px 0px #0a0d120d]"
                  ...
                  <div className="flex flex-col gap-5">
                    ...
                    <Tabs
                      defaultValue={item.tabs[0].title}
                      className="max-w-7xl"
                    >
...
export default SimilarItemPage;
