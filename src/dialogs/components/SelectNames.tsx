...
const SelectNames = () => {
  ...
  return (
    ...
    >
      <DialogContent className="flex flex-col gap-8 max-w-md! ">
        ...
        has-aria-checked:border-[#D6BBFB] has-aria-checked:bg-[#F9F5FF]"
              >
                ...
                <Checkbox
                  ...
                  className="rounded-full border-gray-300 bg-white h-4 w-4 data-[state=checked]:border-[#7F56D9] data-[state=checked]:bg-[#7F56D9] data-[state=checked]:text-white"
                />
              </Label>
            ))}
        </div>
        ...
        <div className="flex items-center justify-between gap-2">
          <Button
            onClick={closeDialog}
            className="w-1/2 text-gray-700 text-[16px] font-semibold leading-6 rounded-lg bg-white py-2.5 px-[18px] border border-gray-300 cursor-pointer shadow-[0px_1px_2px_0px_#0A0D120D] hover:bg-white"
            size={"lg"}
          >
            Cancel
          </Button>
    ...
    w-1/2 text-white text-[16px] font-semibold leading-6 rounded-lg py-2.5 px-[18px]
    bg-primary border border-gray-300 shadow-[0px_1px_2px_0px_#0A0D120D]
